Feature: Dashboard
  ...
  Scenario: display description
    ...
    Then I should see the "stacked_categories" module for "no-realistic-dashboard" data
     And I should see the table for the "no-realistic-dashboard" "stacked_categories" module
    ...
    #Then I should see the "realtime" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "realtime" module
    ...
    #Then I should see the "journey" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "journey" module
    ...
    #Then I should see the "availability" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "availability" module
    ...
    #Then I should see the "completion_rate" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "completion_rate" module
    ...
    #Then I should see the "completion_numbers" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "completion_numbers" module
    ...
    #Then I should see the "multi_stats" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "multi_stats" module
    ...
    #Then I should see the "starts_completions" module for "no-realistic-dashboard" data
     #And I should see the table for the "no-realistic-dashboard" "starts_completions" module
